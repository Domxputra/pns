            ...
            <div class="card-body">
                <form action="">
                    <div class="form-group">
                      ...
                      <input type="text"
                        class="form-control" name="nik_ayah" value="<?=$item['nik_ayah']?>" placeholder="masukkan nik ayah">
                    </div>
                    <div class="form-group">
                      <label for="">Nama Ayah</label>
                      <input type="text"
                        class="form-control" name="nama_ayah" value="<?=$item['nama_ayah']?>" placeholder="masukkan Nama ayah">
                    </div>
                    <div class="form-group">
