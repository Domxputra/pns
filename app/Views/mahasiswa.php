            ...
            <div class="card-body">
                <table class="table table-bordered ">
                    ...
                    <?php foreach ($orang_tua as $key => $item) : ?>
                        ...
                        <td>
                            <a href="<?= base_url("mahasiswa/ubah/") . $item['nik'] ?>" class="btn btn-warning btn-sm">Edit</a>
                            <a href="<?= base_url("mahasiswa/hapus/") . $item['nik'] ?>" class="btn btn-danger btn-sm">Hapus</a>
                        </td>
                    <?php endforeach; ?>
                </table>
            </div>
